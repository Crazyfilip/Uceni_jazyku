...
namespace LanguageLearning.Cycle
{
    ...
    public class CycleService
    {
        ...
        public UserCycle GetNewCycle(string username)
        {
            ...
            List<UserCycleItem> program = ProgramPlanner.GetNextUserCycleProgram(username);
        ...
        public string GetNextLesson(string username)
        {
            ...
            UserCycleItem item = ProgramPlanner.GetNextLanguageLesson(username);
        ...
        public string GetNextLesson(string username, string topicId)
        {
            ...
            UserCycleItem item = ProgramPlanner.GetNextLanguageLesson(username, topicId);
        ...
        public List<UserCycleItem> GetPlannedUnfinishedLessons(string username)
        {
