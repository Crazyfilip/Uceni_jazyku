...
namespace UnitTests.Cycle
{
    ...
    public class CycleServiceTests
    {
        ...
        [TestMethod]
        public void TestGetNextCyclePositiveFromActive()
        {
            // Init
            Mock<UserCycle> cycleMock = new Mock<UserCycle>();
            databaseMock.Setup(x => x.GetActiveCycle("test", "course_id")).Returns(cycleMock.Object);
        ...
        public void TestGetNextCyclePositiveCreateNew()
        {
            ...
            Mock<List<UserCycleItem>> programMock = new Mock<List<UserCycleItem>>();
        ...
        public void TestGetNewCyclePositive()
        {
            ...
            plannerMock.Setup(x => x.GetNextUserCycleProgram("test")).Returns(programMock.Object);
            cycleFactoryMock.Setup(x => x.CreateCycle("test", "course_id", programMock.Object)).Returns(cycleMock.Object);
            databaseMock.Setup(x => x.Create(cycleMock.Object)).Verifiable();
        ...
        public void TestSwapLessonPositiveNewIncomplete()
        {
            ...
            Mock<UserCycleItem> userItemMock1 = new Mock<UserCycleItem>();
            Mock<UserCycleItem> userItemMock2 = new Mock<UserCycleItem>();
            ...
            databaseMock.Verify(x => x.Create(incompleteCycleMock.Object), Times.Once);
            databaseMock.Verify(x => x.Update(cycleMock.Object), Times.Once);
            databaseMock.Verify(x => x.Update(incompleteCycleMock.Object), Times.Once);
        ...
        public void TestGetPlannedUnfinishedLessonsPositive()
        {
            ...
            Mock<UserCycleItem> userItem1 = new();
            Mock<UserCycleItem> userItem2 = new();
            ...
            cycleMock.SetupGet(x => x.UserProgramItems).Returns(new List<UserCycleItem>() { userItem1.Object, userItem2.Object });
            databaseMock.Setup(x => x.GetNotFinishedCycles("test", "course_id")).Returns(new List<UserCycle>() { cycleMock.Object });

            // Test
            List<UserCycleItem> result = service.GetPlannedUnfinishedLessons("test");

            // Verify
            CollectionAssert.AreEqual(new List<UserCycleItem>() { userItem2.Object }, result);
        ...
        public void TestGetPlannedUnfinishedLessonsNegative()
        {
            ...
            // Verify
            CollectionAssert.AreEqual(new List<UserCycleItem> { }, result);
        ...
        public void TestUpdatePositiveUnfinished()
        {
            ...
            databaseMock.Verify(x => x.Update(userCycle.Object), Times.Once);
